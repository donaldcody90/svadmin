...
<div id="content" class="container fullwidth">
    ...
    <form name="edit" action="" method="POST">
        <div class="group-input">
            ...
            <input placeholder="Username" type="text" readonly="" value="<?php echo $data['c_username']; ?>" name="c_username" required="">
        </div>
        <div class="group-input">
            <label class="label_input">Fullname <span class="red"></span></label>
            <input placeholder="Phone" type="text" value="<?php echo $data['c_fullname']; ?>" name="c_fullname" required="">
        </div>
        <div class="group-input">
            <label class="label_input">Phone <span class="red"></span></label>
            <input placeholder="Phone" type="text" value="<?php echo $data['c_phone']; ?>" name="c_phone" required="">
        </div>
        <div class="group-input">
            <label class="label_input">Email <span class="red"></span></label>
            <input placeholder="Email" type="text" value="<?php echo $data['c_email']; ?>" name="c_email" required="">
        </div>
        <div class="group-input">
            <label class="label_input">Yahoo <span class="red"></span></label>
            <input placeholder="Yahoo" type="text" value="<?php echo $data['yahoo']; ?>" name="yahoo">
        </div>
        <div class="group-input">
            <label class="label_input">Skype <span class="red"></span></label>
            <input placeholder="Skype" type="text" value="<?php echo $data['skype']; ?>" name="skype">
        </div>
        <div class="group-input">
