...
<?php $this->load->view('_base/message'); ?>
		...
		<div class="information clearfix">
			...
			<div class="detail">
				<div class="left">
					<div class="item">
						<b>Tên khách : </b> <?php echo $order['c_fullname']; ?>
					</div>
					<div class="item">
		    ...
		    ?>
		    	...
		    	?>
					        <tr>
					            ...
					            <td>
					               <div class="red">
					               		<?php echo vst_showPrice( $value_items_by_seller['item_quantity']*$value_items_by_seller['item_price'] ); ?>
					               </div>                                                            
					            </td>
								<?php if($tmp==1){ ?>
								<td rowspan="<?php echo (count($value_sellers['items']) +1); ?>">
								   ...
								   <h3>Danh sách vận đơn</h3>
									...
									<form action="" class="ajaxFormShip" method="POST" >
										...
										<input type="text" name="shipid" value="" placeholder="Mã vận đơn" size="19">
														...
														<li class="clearfix itemVandon<?php echo $value_shipid['id']; ?>">
															<div class="formVandonDelete clearfix">
																<form action="" class="formVandonDelete" method="post">
																	...
																	<a class="button-link vandon small" onClick="submitAjax(this,'Bạn chắc chắn muốn xóa???')">Delete</a>
																	<input type="hidden" name="controller" value="orders" />
